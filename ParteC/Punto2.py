...
#de sistema es: subamortiguado, criticamente amortiguado y sobreamortiguado.import numpy as np
...
print(f"Valor final esperado (ganancia K): {K}")

plt.figure(figsize=(9, 6))
plt.plot(t, y, color="navy", linewidth=2)
plt.axhline(K, color="gray", linestyle="--", linewidth=0.8, label=f"Valor final = K = {K}")
plt.title(f"Respuesta al escalón | K={K}, wn={wn} rad/s, zeta={zeta}\n{tipo}")
plt.xlabel("Tiempo (s)")
